...
using static CO2.Application.AutoMapper;
...
namespace CO2.Companies {
    public class CompanyAppServices: ICompanyAppServices {
        ...
        public virtual async Task<List<CompanyDto>> GetListAsync(CompanyFilterDto valFilterDto) {
            return ObjectMapper.Map<List<CompanyDto>>(await _companyRepository.GetListAsync(valFilterDto.Name, valFilterDto.OnlyActives));
        }
    }
}
