...
namespace CEmission.EntityFramework.Migrations
{
    ...
    [Migration("20241005045712_CompaniesSeeding")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CO2.Companies.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CO2.Emissions.Emission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CO2.Emissions.Emission", b =>
                {
                    b.HasOne("CO2.Companies.Company", null)
                        .WithMany()
